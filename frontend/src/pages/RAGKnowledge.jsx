...
export default function RAGKnowledge() {
  ...
  const chunksList = analysis.ragChunks || []
  ...
  const handleQuerySubmit = (e) => {
    ...
    setIsQuerying(true)
    setTimeout(() => {
      const result = queryRAGKnowledgeBase(queryInput, currentDatasetKey)
  ...
  const handleSuggestedClick = (question) => {
    ...
    setIsQuerying(true)
    setTimeout(() => {
      const result = queryRAGKnowledgeBase(question, currentDatasetKey)
      setActiveQueryResult(result)
      setIsQuerying(false)
    }, 900)
  }
